...
?>
    ...
    <form method="post" action="{{ route('BN_stores_edit_action', ['id' => $stores->id]) }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3 ">
                                    ...
                                    <input type="text" class="form-control w-full" value="{{$stores->name}}" name="name" autocomplete="off" required />
                                </div>
                                
                                <div class="mt-3 ">
                                    <label for="" class="form-label">อีเมล</label>
                                    <input type="text" class="form-control w-full" value="{{$stores->email}}" name="email"  autocomplete="off" />
                                </div>
                                <!-- <div class="mt-3">
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3 ">
                                    <label for="" class="form-label">ราคา RO</label>
                                    <input type="text" class="form-control w-full" id="" name="ro" value="{{$stores->ro}}">
                                </div>
                                <div class="mt-3 ">
                                    <label for="" class="form-label">ราคา ALKALINE</label>
                                    <input type="text" class="form-control w-full" id="" name="alkaline" value="{{$stores->alkaline}}">
                                </div>
                                <div class="mt-3 ">
                                    <label for="" class="form-label">ราคา OXYGEN</label>
                                    <input type="text" class="form-control w-full" id="" name="oxygen" value="{{$stores->oxygen}}">
                                </div>
