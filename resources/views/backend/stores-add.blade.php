                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3 ">
                                    ...
                                    <input type="text" class="form-control w-full" id="" name="ro" >
                                </div>
                                <div class="mt-3 ">
                                    <label for="" class="form-label">ราคา ALKALINE</label>
                                    <input type="text" class="form-control w-full" id="" name="alkaline" >
                                </div>
                                <div class="mt-3 ">
                                    <label for="" class="form-label">ราคา OXYGEN</label>
                                    <input type="text" class="form-control w-full" id="" name="oxygen" >
                                </div>
