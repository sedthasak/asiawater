...
@section('subcontent')
    ...
    <div class="intro-y box flex flex-col lg:flex-row mt-5">
        <div class="intro-y flex-1 px-5 py-16">
            ...
            <div class="text-slate-600 text-center mt-5">
        ...
        <div class="intro-y border-b border-t lg:border-b-0 lg:border-t-0 flex-1 p-5 lg:border-l lg:border-r border-slate-200/60 py-16">
    ...
    <div class="intro-y box flex flex-col lg:flex-row mt-5">
        ...
        <div class="intro-y border-b border-t lg:border-b-0 lg:border-t-0 flex-1 px-5 lg:border-l lg:border-r border-slate-200/60 py-16">
