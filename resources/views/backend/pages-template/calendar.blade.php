    ...
    <div class="grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
            <div class="box p-5 intro-y">
                ...
                <div class="border-t border-b border-slate-200/60 mt-6 mb-5 py-3" id="calendar-events">
                    <div class="relative">
                        <div class="event p-3 -mx-3 cursor-pointer transition duration-300 ease-in-out hover:bg-slate-100 rounded-md flex items-center">
