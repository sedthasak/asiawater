                ...
                <div id="heading" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5">
                            ...
                            <h2 class="text-3xl text-slate-600 font-medium leading-none mt-3">h2. Heading 2</h2>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
                ...
                <div id="badge" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-2">
                            ...
                            <span class="text-xs px-1 rounded-full border text-slate-600 mr-1">2</span>
                            ...
                            <span class="text-xs px-1 rounded-full bg-slate-100 text-slate-500 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-6">Badge Sizes</div>
                        <div class="mt-3">
                            <span class="px-2 py-1 rounded-full bg-primary text-white mr-1">1</span>
                            <span class="px-2 py-1 rounded-full border text-slate-600 mr-1">2</span>
                            ...
                            <span class="px-2 py-1 rounded-full bg-slate-100 text-slate-500 mr-1">6</span>
                        </div>
                        <div class="mt-4">
                            <span class="px-3 py-2 rounded-full bg-primary text-white mr-1">1</span>
                            <span class="px-3 py-2 rounded-full border text-slate-600 mr-1">2</span>
                            ...
                            <span class="px-3 py-2 rounded-full bg-slate-100 text-slate-500 mr-1">6</span>
                        </div>
                        <div class="mt-6">
                            <span class="px-4 py-3 rounded-full bg-primary text-white mr-1">1</span>
                            <span class="px-4 py-3 rounded-full border text-slate-600 mr-1">2</span>
                            ...
                            <span class="px-4 py-3 rounded-full bg-slate-100 text-slate-500 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-10">Square Badge</div>
                        <div class="mt-2">
                            <span class="text-xs px-1 bg-primary text-white mr-1">1</span>
                            <span class="text-xs px-1 border text-slate-600 mr-1">2</span>
                            ...
                            <span class="text-xs px-1 bg-slate-100 text-slate-500 mr-1">6</span>
                        </div>
                        <div class="font-medium mt-6">Outline Badge</div>
                        <div class="mt-4">
                            <span class="px-3 py-2 rounded-full border border-primary text-primary mr-1">1</span>
                            <span class="px-3 py-2 rounded-full border text-slate-600 mr-1">2</span>
                            <span class="px-3 py-2 rounded-full border border-success text-success mr-1">3</span>
                            <span class="px-3 py-2 rounded-full border border-warning text-warning mr-1">4</span>
                            <span class="px-3 py-2 rounded-full border border-danger text-danger mr-1">5</span>
                        </div>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                ...
                <div id="separator" class="p-5">
                    <div class="preview">
                        ...
                        <div class="w-full border-t border-slate-200/60 mt-5"></div>
                    </div>
                    <div class="source-code hidden">
            ...
            <div class="intro-y box mt-5">
                ...
                <div id="devider" class="p-5">
                    <div class="preview">
                        <div class="w-full flex justify-center border-t border-slate-200/60 mt-2">
                            <div class="bg-white px-5 -mt-3 text-slate-500">or</div>
                        </div>
                    </div>
                    <div class="source-code hidden">
                ...
                <div id="link" class="p-5">
                    <div class="preview">
                        ...
                        <div class="mt-5">
                            ...
                            <a href="" class="text-slate-600 block">Secondary state</a>
