    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        <div class="px-5 sm:px-20">
            ...
            <div class="intro-x flex items-center mt-5">
                ...
                <div class="text-base text-slate-600 ml-3">Setup Your Profile</div>
            </div>
            <div class="intro-x flex items-center mt-5">
                <button class="w-10 h-10 rounded-full btn text-slate-500 bg-slate-100">3</button>
                <div class="text-base text-slate-600 ml-3">Setup Your Business Details</div>
            </div>
            <div class="intro-x flex items-center mt-5">
                <button class="w-10 h-10 rounded-full btn text-slate-500 bg-slate-100">4</button>
                <div class="text-base text-slate-600 ml-3">Setup Billing Account</div>
            </div>
            <div class="intro-x flex items-center mt-5">
                <button class="w-10 h-10 rounded-full btn text-slate-500 bg-slate-100">5</button>
                <div class="text-base text-slate-600 ml-3">Finalize your purchase</div>
            </div>
        </div>
