...
@section('subcontent')
    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        <div class="flex justify-center">
            ...
            <button class="intro-y w-10 h-10 rounded-full btn bg-slate-100 text-slate-500 mx-2">2</button>
            <button class="intro-y w-10 h-10 rounded-full btn bg-slate-100 text-slate-500 mx-2">3</button>
        </div>
